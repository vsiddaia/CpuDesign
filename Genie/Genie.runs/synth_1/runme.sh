...
HD_PWD='C:/Xilinx/13May2019/CpuDesign/Genie/Genie.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CpuTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CpuTop.tcl
